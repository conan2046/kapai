...
function Main(pUser,pos,num)
	...
	local award = {{awardType = 854, num = 1}, {awardType = 614, num = 20}, {awardType = 2539, num = 8},{awardType = 60000, num = 50000},}
	local info = ""
	...
	j.SaveUseItemStr(pUser:GetRoleId(), pItem.tmplId, LANGUAGE_TRANSFORM_932, 1,"", "")
end
