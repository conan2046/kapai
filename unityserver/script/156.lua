...
MonsterName = LANGUAGE_TRANSFORM_1670
LEVEL_LIMIT = 30
...
function NpcMain(pUser,missionId,index)
	...
	Option(pUser,MonsterName,LANGUAGE_TRANSFORM_1671,LANGUAGE_TRANSFORM_1672)
...
function MonsterCallBack(pUser,sel)
	if sel == 1 then
		if pUser:GetLevel() < LEVEL_LIMIT then
			Dialog(pUser,MonsterName,LANGUAGE_TRANSFORM_1673..LEVEL_LIMIT..LANGUAGE_TRANSFORM_1674)
			return
		end
