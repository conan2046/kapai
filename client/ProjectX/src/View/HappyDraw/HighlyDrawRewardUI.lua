...
local HighlyDrawRewardUI = LUIBase:New()
HighlyDrawRewardUI.__index = HighlyDrawRewardUI
--local this = LTcpSocket
function HighlyDrawRewardUI:New()
    local o = LUIBase:New()
    setmetatable(o,HighlyDrawRewardUI)  
    o:Init()
    return o
end
...
--注册事件
-- -----------------------------------
function HighlyDrawRewardUI:RegistMsgs()
    self.msgIds = 
    {
    }
...
-- -----------------------------------
function HighlyDrawRewardUI:ProcessEvent(msg)

end

function HighlyDrawRewardUI:Init()
...
function HighlyDrawRewardUI:initData( ... )
    ...
    for i=1, #drawConfig do
        ...
        -- dump(data, "HighlyDrawRewardUI:initData ===>")
...
function HighlyDrawRewardUI:initControlUI( ... )
    -- body
...
function HighlyDrawRewardUI:GetTableSize(idx)
...
function HighlyDrawRewardUI:InitTableView()
...
function HighlyDrawRewardUI:TableCellAtIndex(sender, idx)
...
function HighlyDrawRewardUI:ShowTableCellInfo(cellChild, idx)
...
--加载一个推荐的Icon列表
function HighlyDrawRewardUI:ShowItemList(parent,tag,petIds)
...
--加载单个神将
function HighlyDrawRewardUI:ShowItem(item,id)
...
function HighlyDrawRewardUI:SetPosPercentY(node,flag,height)
...
function HighlyDrawRewardUI:SetPosDifY(node,flag,height)
    if node == nil then return end
    local x,y = node:getPosition()
    y = height-flag
    node:setPosition(cc.p(x,y))
...
function HighlyDrawRewardUI:CloseUI( ... )
    -- body
    Utils:DeleteUI("HappyDraw.HighlyDrawRewardUI")
end

function HighlyDrawRewardUI:onExit()
    self.m_pUILayer = nil
    self:Destory()
end

return HighlyDrawRewardUI