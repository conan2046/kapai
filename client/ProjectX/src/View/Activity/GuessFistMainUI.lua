local GuessFistMainUI = LUIBase:New()
GuessFistMainUI.__index = GuessFistMainUI

function GuessFistMainUI:New(openTab)
    local o = LUIBase:New()
    setmetatable(o,GuessFistMainUI)
    o:Init(openTab)
    return o
end

function GuessFistMainUI:Init(openTab)
    ...
    LGameMsg.m_baseMsgWithOne:Change(LUIFClassBgEvent.SetTitle, GUITips.UI_Title_Guess_Fist)
...
function GuessFistMainUI:onExit()
    self:Destory()
    self.m_pUILayer = nil
end

function GuessFistMainUI:InitTouchEvt()
...
function GuessFistMainUI:TabClicked(ind)
...
function GuessFistMainUI:HideCurUI()
...
function GuessFistMainUI:ShowCurUI()
...
function GuessFistMainUI:DelayLoadSubUI(tabInd)
    local uinames = {"View.Activity.GuessFistUI",}
    local ind = tabInd
