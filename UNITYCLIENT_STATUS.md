...
7. 决战昆仑、血战、法宝搜索、七日目标、将魂/竞技场/血战商店、体力领取、资源找回及成长/活跃基金已完成只读首期并通过门禁；好友赠送、好友深化、组队深化统一放到末尾。
8. 新模块停止新增业务型 `Store/Catalog/Presenter`；阵容先验证“旧 Lua 权威状态 + C# 渲染适配”路线，验证通过后再推广，禁止一次性推倒已完成模块。
