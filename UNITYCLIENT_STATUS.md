...
| Functional | `约47%` | 当前活动、神将招募、玩法大厅、决战昆仑、血战、法宝搜索与七日目标只读首期已计入；旧 `/209`、旧 LuckyDraw 误版本均不计完成口径 |
...
| 玩法大厅及首批子页 | `logic-validated-visual-deferred` | 大厅真实布局、游历、封神列传、竞技场、决战昆仑 `/213`、血战 `/323`、法宝搜索 `/319`、七日目标 `/37` 均已跑通 | 好友赠送与组队统一后置；下一未完成模块为将魂商店 |
...
7. 决战昆仑、血战、法宝搜索、七日目标已完成只读首期并通过门禁；好友赠送、好友深化、组队深化统一放到末尾，下一项为将魂商店。
