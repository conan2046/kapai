...
## 4. 当前批次
World（世界/战斗/副本）G0-G6 已通过并收口：25/25 控件、5/5 语义、6/6 视觉状态、固定账号精确恢复、切号隔离、零 Fixture 残留和双次 BuildBatch 均通过。扫荡结果按“扫荡 N 次收益汇总”展示所有收益总量。严格完成率为 `9/29 = 31.0%`；Cocos、Unity、服务端和工作区 MySQL 均已停止。下一任务重新选择一个模块，从 G0 开始。
