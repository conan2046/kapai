...
local AWARD = {}
AWARD[1] = {ratio = 1491, award = {{awardType = 2548, num = 1},}}
AWARD[2] = {ratio = 2733, award = {{awardType = 2549, num = 1},}}
AWARD[3] = {ratio = 3106, award = {{awardType = 2550, num = 1},}}
AWARD[4] = {ratio = 3292, award = {{awardType = 2551, num = 1},}}
AWARD[5] = {ratio = 7019, award = {{awardType = 2552, num = 1},}}
AWARD[6] = {ratio = 8882, award = {{awardType = 2553, num = 1},}}
AWARD[7] = {ratio = 9627, award = {{awardType = 2554, num = 1},}}
AWARD[8] = {ratio = 10000, award = {{awardType = 2555, num = 1},}}

local bless = {LANGUAGE_LLD_0020,LANGUAGE_LLD_0021,LANGUAGE_LLD_0022,LANGUAGE_LLD_0023,LANGUAGE_LLD_0024,LANGUAGE_LLD_0025,LANGUAGE_LLD_0026,LANGUAGE_LLD_0027,
				LANGUAGE_LLD_0028,LANGUAGE_LLD_0029}
...
function NpcMain(pUser,missionId)
	...
	opt = opt .. "1|" ..LANGUAGE_LLD_0018.. "|"
	
	s = string.format(LANGUAGE_LLD_0019, costYB)
	opt = opt .. "2|"..s.."|"

	opt = string.sub(opt,1,-2)
	if #opt ~= 0 then
		Option(pUser,NPCName,LANGUAGE_LLD_0017,opt)
		pUser:SetCallFun("NpcMainSel")
	else
		Dialog(pUser,NPCName,LANGUAGE_LLD_0017)
	end
end
...
function NpcMainSel(pUser,sel)
	if sel == 1 then
		...
		if pUser:GetExtData8(387) >= 5  then
			Dialog(pUser,NPCName,LANGUAGE_CHY_294)
			return
		end 
		if pUser:GetExtData32(291) +5*60 > j.GetSystemTime() then
			Dialog(pUser,NPCName,LANGUAGE_CHY_295)
			return
		end 
